(function(){
  ...
  var imgWorker = new Worker('./scripts/worker.js');
      imgWorker.onmessage = handleImgWorkerResponse;
  ...
  function manipulateImage(type) {
    ...
    imgWorker.postMessage({imageData: imageData, type: type})

  };

  function handleImgWorkerResponse(msg) {
    console.log(msg)
    toggleButtonsAbledness();
    return ctx.putImageData(msg.data, 0, 0);
  }
